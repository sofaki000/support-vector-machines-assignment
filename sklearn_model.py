...
def run_sklearn_svm(X_train, X_test,y_train,y_test, C=1, file_name="sklearn_algo"):
    # le = LabelEncoder()
    # y_train = le.fit_transform(y_train)

    classifier = SVC(kernel='linear', random_state =1 , C=C)
    ...
    acc_result = f"\nAccuracy: {accuracy}, M={margin:.2f}, C={C}"
    print(acc_result)
